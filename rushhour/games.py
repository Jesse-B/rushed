...
def field2():
    ...
    v1 = Vehicle([(1, 2), (1, 1)], "vertical", "orange")
    v2 = Vehicle([(1, 3), (2, 3)], "horizontal", "green")
    v3 = Vehicle([(3, 3), (4, 3)], "horizontal", "blue")
    v4 = Vehicle([(4, 2), (4, 1)], "vertical", "blue") # lightblue
    v5 = Vehicle([(5, 1), (6, 1)], "horizontal", "orange")
    v6 = Vehicle([(5, 2), (6, 2)], "horizontal", "green")
    v7 = Vehicle([(5, 4), (5, 3)], "vertical", "blue") # lightblue
    v8 = Vehicle([(2, 5), (3, 5)], "horizontal", "orange")
    v9 = Vehicle([(4, 5), (5, 5)], "horizontal", "green")
    v10 = Vehicle([(6, 5), (6, 4), (6, 3)], "vertical", "yellow")
    v11 = Vehicle([(3, 6), (4, 6)], "horizontal", "blue")
    v12 = Vehicle([(5, 6), (6, 6)], "horizontal", "orange")
    red = Vehicle([(3, 4), (4, 4)], "horizontal", "red")
...
def field3():
    ...
    v1 = Vehicle([(2, 6), (3, 6)], "horizontal", "blue")
    v2 = Vehicle([(4, 6), (5, 6), (6, 6)], "horizontal", "yellow")
    v3 = Vehicle([(2, 5), (3, 5)], "horizontal", "orange")
    v4 = Vehicle([(4, 5), (4, 4)], "vertical", "blue")
    v5 = Vehicle([(5, 5), (6, 5)], "horizontal", "green")
    v6 = Vehicle([(3, 4), (3, 3)], "vertical", "blue") # lightblue
    v7 = Vehicle([(1, 3), (2, 3)], "horizontal", "green")
    v8 = Vehicle([(4, 3), (5, 3)], "horizontal", "blue")
    v9 = Vehicle([(6, 4), (6, 3)], "vertical", "blue") # lightblue
    v10 = Vehicle([(1, 2), (1, 1)], "vertical", "orange")
    v11 = Vehicle([(3, 2), (3, 1)], "vertical", "green")
    v12 = Vehicle([(5, 2), (6, 2)], "horizontal", "green")
    red = Vehicle([(1, 4), (2, 4)], "horizontal", "red")
